...
function setScene(){
  ...
  const beianBorder = 70
  camera=new THREE.PerspectiveCamera(70,innerWidth/(innerHeight - beianBorder),.5,1500);
  camera.position.set(-20,-155,90);

  renderTarget=new THREE.WebGLRenderTarget(innerWidth,innerHeight - beianBorder);

  renderer=new THREE.WebGLRenderer();
  renderer.setSize(innerWidth,innerHeight - beianBorder);
